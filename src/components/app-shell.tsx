  ...
  return [
    {
      ...
      items: [
        ...
        { href: "/orders/boarding", label: t.nav.ordersBoarding, icon: OrdersImageIcon, hiddenForGroomer: true },
        ...
        { href: "/calendar-other", label: t.nav.otherServiceCalendar, icon: ServiceCalendarImageIcon },
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/settings/flea-tick", label: t.nav.fleaTick, icon: ClipboardFlatIcon, hiddenForGroomer: true },
